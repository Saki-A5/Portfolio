  ...
  return (
    ...
    <div className='flex items-center gap-2 mt-12 z-50 mr-8 top-4 md:hidden right-4'>
      ...
      <Button className='ml-auto' onClick={() => setIsOpen(!isOpen)}>
        {isOpen ? (
          <svg  xmlns="http://www.w3.org/2000/svg" width={30} height={30} fill={"white"} viewBox="0 0 24 24"><path d="M9 13h7v-2H9V7l-6 5 6 5z"></path><path d="M19 3h-7v2h7v14h-7v2h7c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2"></path></svg>
        ) : (
          <div className='text-white fill-white'>
            <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} fill={"white"} viewBox="0 0 24 24"><path d="M3 11H14V13H3z"></path>
